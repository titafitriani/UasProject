...
@section('content')
  ...
  <div class="panel-body">
    ...
    <input class="form-control input-sm" name="namabarang" id="inputsm" type="text">
  </div>
   <div class="form-group">
    <label for="inputdefault">Jumlah Barang Masuk</label>
    <input class="form-control" name="jumlahbarangmasuk" id="inputdefault" type="text">
  </div>
  <div class="form-group">
    <label for="inputlg">Tanggal Barang Masuk</label>
    <input class="form-control input-lg" name="tanggalmasukbarang" id="inputlg" type="date">
  </div>
	<div class="form-group">
